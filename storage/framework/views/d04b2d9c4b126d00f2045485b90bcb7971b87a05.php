                ...
                <form method="POST" action="<?php echo e(route('register')); ?>">
                    ...
                    <div class="card p-4 border-0 shadow-sm">
                        <div class="text-center mb-4" style="margin-top: -10vh">
                            <img src="<?php echo e(asset('image/icon/sidebar/profile.png')); ?>" width="80" class="rounded-circle p-3 mb-4 bg-secondary shadow" />
                            <h4>CREATE ACCOUNT</h4>
                            <h6 class="text-muted">Register your personal data</h6>
                        </div>
                        <div class="form-group mb-4">
                            <div class="input-group">
                                <input type="text" class="form-control border-0 border border-bottom <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            <div class="input-group">
                                <input type="email" class="form-control border-0 border border-bottom <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            <div class="input-group">
                                <input type="password" class="form-control border-0 border border-bottom <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group mb-4">
                            <div class="input-group">
                                <input type="password" class="form-control border-0 border border-bottom <?php $__errorArgs = ['confirm_password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password_confirmation" value="<?php echo e(old('password_confirmation')); ?>" required autocomplete="password_confirmation" autofocus placeholder="Confirm Password" />
                                <span class="input-group-text bg-white border-0 border-bottom border-1">
                                    🔒
                                </span>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/aldiansyahibrahim/Documents/projects/KMS-APP/resources/views/auth/register.blade.php ENDPATH**/ ?>