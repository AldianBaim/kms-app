...
class PredictionController extends Controller
{
    ...
    /**
     * Get top plants by average price for comparison chart
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function topPlantsComparison(Request $request)
    {
        ...
        $query = Prediction::select('plant_type')
    ...
    /**
     * Get monthly trend data for seasonal analysis
     *
     * @param Request $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function monthlyTrend(Request $request)
    {
        ...
        $query = Prediction::selectRaw('MONTH(tanggal) as month, AVG(price) as avg_price')
            ->groupBy('month')
            ->orderBy('month');
