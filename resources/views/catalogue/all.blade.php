...
<section class="p-3">
    <h4>Katalog.</h4>
    <p><small>Daftar katalog Aglaonema dari Berbagai Petani Penjuru Indonesia.</small></p>
        ...
        <div class="col-md-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted">Tani Maju Lembang</p>
                    ...
                    <button class="btn btn-warning btn-sm pull-right"><span class="fa fa-cart-shopping"></span> Kontak</button>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100">
               <img src="https://ik.imagekit.io/6ix6n7mhslj/KMS/Screenshot%202024-03-27%20at%2015.04.24__P2Mqin4b.png?updatedAt=1711526682613" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <p class="text-muted">Raja Aglaonema Nusantara</p>
            ...
            <div class="card h-100">
               <img src="https://ik.imagekit.io/6ix6n7mhslj/KMS/Screenshot%202024-03-27%20at%2015.09.07_27jYXuv_r.png?updatedAt=1711526962091" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <p class="text-muted">Koperasi Tani Bandung</p>
            ...
            <div class="card h-100 mt-4">
               <img src="https://ik.imagekit.io/6ix6n7mhslj/KMS/Screenshot%202024-03-27%20at%2016.43.38_m3pfMg-_z.png?updatedAt=1711532654861" class="card-img-top" alt="...">
                <div class="card-body">
                    ...
                    <p class="text-muted">Fhandi (FF Nursery Aglaonema)</p>
